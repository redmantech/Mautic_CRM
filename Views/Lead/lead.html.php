...
<link rel="stylesheet" href="/plugins/CustomCrmBundle/Assets/css/leadactions.css" />
<link rel="stylesheet" href="/plugins/CustomCrmBundle/Assets/css/opportunity.css" />

<script type="text/javascript" src="/plugins/CustomCrmBundle/Assets/js/opportunity.js"></script>
...
if ($edit) {
    ...
    $buttons[] = array(
        'attr'      => array(
            ...
            'data-target' => '#MauticSharedModal',
            'data-header' => $view['translator']->trans('mautic.lead.note.header.new'),
            'href'        => $view['router']->generate('mautic_task_action', array('objectId' => $lead->getId(), 'objectAction' => 'new'))
        ),
        'btnText'   => $view['translator']->trans('ddi.lead_actions.add.task'),
        'iconClass' => 'fa fa-file-o'
    );
}
...
<div class="box-layout">
    ...
    <div class="col-md-9 bg-white height-auto">
        ...
        <div class="bg-auto bg-dark-xs">
            ...
            <ul class="nav nav-tabs pr-md pl-md mt-10">
                ...
                <li class="">
                    <a href="#tasks-container" role="tab" data-toggle="tab">
                        <span class="label label-primary mr-sm" id="TaskCount">
                            <?php echo $tasksCount; ?>
                        </span>
                        <?php echo $view['translator']->trans('ddi.lead_actions.tasks'); ?>
                    </a>
                </li>

                <li class="">
                    <a href="#opportunities-container" role="tab" data-toggle="tab">
                        <span class="label label-primary mr-sm" id="OpportunitiesCount">
                            <?php echo count($opportunities) ?>
                        </span>
                        <?php echo $view['translator']->trans('mautic.customcrm.opportunity.tab.opportunity') ?>
                    </a>
                </li>
            </ul>
            <!--/ tabs controls -->
        ...
        <div class="tab-content pa-md">
            ...
            <!-- #tasks-container -->
            <div class="tab-pane fade bdr-w-0" id="tasks-container">
                <?php echo $leadTasks; ?>
            </div>
            <!--/ #opportunities-container -->

            <!-- #opportunities-container -->
            <div class="tab-pane fade bdr-w-0" id="opportunities-container">
                <?php echo $view->render('CustomCrmBundle:Opportunity:tab.html.php', array('lead' => $lead, 'opportunities' => $opportunities)) ?>
            </div>
            <!--/ #opportunities-container -->
        </div>
        <!--/ end: tab-content -->
    ...
    <div class="col-md-3 bg-white bdr-l height-auto">
        ...
        <div class="mt-sm tasks-block">
            <hr />
            <div class="panel-heading">
                <div class="panel-title">Tasks</div>
                <a class="btn btn-primary pull-right" href="<?php echo $view['router']->generate('mautic_task_action', array('objectId' => $lead->getId(), 'objectAction' => 'new')); ?>" data-toggle="ajaxmodal" data-target="#MauticSharedModal" data-header="New task">
